...
vector<double> Bert::run(string input_fname, string mask_fname){
    ...
    cout << "> [NETWORK]: Linear 1 consumes: " << double(c_linear_1) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: Linear 2 consumes: " << double(c_linear_2) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: Linear 3 consumes: " << double(c_linear_3) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: Linear 4 consumes: " << double(c_linear_4) / 1024 / 1024 << " Mbytes" << endl; 

    cout << "> [NETWORK]: Softmax consumes: " << double(c_softmax) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: GELU consumes: " << double(c_gelu) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: Layer Norm 1 consumes: " << double(c_ln1) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: Layer Norm 2 consumes: " << double(c_ln2) / 1024 / 1024 << " Mbytes" << endl;
    cout << "> [NETWORK]: Tanh consumes: " << double(c_tanh) / 1024 / 1024 << " Mbytes" << endl;

    cout << "> [NETWORK]: Softmax * V: " << double(c_softmax_v) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: Pruning: " << double(c_pruning) / 1024 / 1024 << " Mbytes" << endl; 
    cout << "> [NETWORK]: Shift consumes: " << double(c_shift) / 1024 / 1024 << " Mbytes" << endl;
    cout << "> [NETWORK]: gt_sub consumes: " << double(c_gt_sub) / 1024 / 1024 << " Mbytes" << endl;  
    
    cout << "> [NETWORK]: Pooling / C consumes: " << double(c_pc) / 1024 / 1024 << " Mbytes" << endl; 
